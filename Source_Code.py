...
st.sidebar.write(":lock-with-ink-pen: Please note that without collecting any personally identifiable data that may be utilized to identify users, 
the collected data for assessment results will be utilized for academic/ researching purposes only and under the Service Provider supervision, 
and for more details; check out [https://sites.google.com/view/big5-personality-assessment/home.](%s)" %Privacy_Policy)
if selected == "Project":
